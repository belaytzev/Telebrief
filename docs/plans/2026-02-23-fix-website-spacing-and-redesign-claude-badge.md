...
- [ ] Run `cd website && npm run build` — must complete without errors
- [ ] Visually inspect `website/dist/index.html` or run `npm run dev` to check layout
- [ ] Confirm hero title and description appear centered
- [ ] Confirm "Powered by Claude Code" button appears blue and button-like
